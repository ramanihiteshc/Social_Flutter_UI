       ...
       children: <Widget>[
        ...
        Row(
          ...
          children: <Widget>[
           IconButton(
             onPressed: () async{
              launch('https://www.facebook.com/darkswiftinfotech');
             },
            icon: Icon(FontAwesomeIcons.facebook),
           ),
            IconButton(
            onPressed: () async{
              launch('https://instagram.com/ramanihiteshc/');
             },
            icon: Icon(FontAwesomeIcons.instagram),
           ),
            IconButton(
             onPressed: () async{
              launch('https://twitter.com/ramanihiteshc');
             },
            icon: Icon(FontAwesomeIcons.twitter),
           ),
            IconButton(
             onPressed: () async{
              launch('https://github.com/ramanihiteshc');
             },
            icon: Icon(FontAwesomeIcons.github),
           ),
            IconButton(
            onPressed: () async{
              launch('https://linkedin.com/in/ramanihitesh/');
             },
